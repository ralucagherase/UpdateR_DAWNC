// Initialize Firebase
var config = {
    apiKey: "AIzaSyCVn2QdVufA-e1WjASoKeaa_WDEN_ofWBo",
    authDomain: "update-rv2.firebaseapp.com",
    databaseURL: "https://update-rv2.firebaseio.com",
    projectId: "update-rv2",
    storageBucket: "",
    messagingSenderId: "437138425353"
};
...
function mainFunctionalityWrapper(usersRef) {
    ...
    chrome.tabs.query({
        ...
        function (tabs) {
            currentUrl = tabs[0].url // Arata mai exact cum vrei sa se comporte site-ul. Nu stiu exact ce e pe

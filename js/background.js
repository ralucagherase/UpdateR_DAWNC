...
// The delay in milliseconds to wait after a check attempt that failed due to the network being down.
...
// Inserts the specified page objects into the pages table in the database.
